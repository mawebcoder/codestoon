...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @return void
     */
    protected function mapAdminRoleApiRoutes()
    {
        Route::prefix('api/v1')
            ->middleware('api')
            ->namespace($this->namespace . '\api\v1\admin\role')
            ->group(base_path('routes/api/v1/admin/role/role.php'));
    }
     ...
     * @return void
     */
    protected function mapAdminVideoApiRoutes()
    {
        Route::prefix('api/v1')
            ->middleware('api')
    ...
    protected function mapAdminUserApiRoutes()
    {
        Route::prefix('api/v1')
            ->middleware('api')
            ->namespace($this->namespace . '\api\v1\admin\users')
            ->group(base_path('routes/api/v1/admin/users/user.php'));
    }
}
